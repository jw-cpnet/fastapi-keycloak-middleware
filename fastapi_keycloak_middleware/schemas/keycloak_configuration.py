...
class KeycloakConfiguration(BaseModel):  # pylint: disable=too-few-public-methods
    ...
    :param swagger_client_secret: Client secret for swagger UI authentication. Defaults to None.
    :type swagger_client_secret: str, optional
    ...
    swagger_client_secret: Optional[str] = Field(
        default=None,
        title="Swagger Client Secret",
        description="The client secret for the swagger UI.",
    )
